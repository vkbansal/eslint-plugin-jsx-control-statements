        ...
        "Program:exit": function (/* node */) {
            ...
            globalScope.through.forEach(function (ref) {
                ...
                while (thisElement.parent) {
                    ...
                    if (
                        thisElement.type === "JSXElement" &&
                        utils.isForComponent(thisElement.openingElement)
                    ) {
                        // Index the <For>'s attributes by name.
                        var attrMap = thisElement.openingElement.attributes.reduce(function (
                            result,
                            attr
                        ) {
                        ...
                        if (
                            (attrEach && attrEach.value.value === identifierName) ||
                            (attrIndex && attrIndex.value.value === identifierName)
                        ) {
                            return;
                        }
                    }
                    ...
                    if (
                        thisElement.type === "JSXElement" &&
                        utils.isWithComponent(thisElement.openingElement)
                    ) {
